...
// In production, /public-objects/ returns HTML (SPA fallback) instead of the actual image.
// Rewrite to /api/public-media/public/ which correctly proxies from Object Storage.
...
// NOTE: /public-objects/ is excluded because CF Image Transform cannot fetch from Object Storage proxy
