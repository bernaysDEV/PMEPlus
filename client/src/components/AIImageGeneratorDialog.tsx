...
// Color style options for news graphics - Property ME branding, minimal and elegant
const colorStyles = {
  red: {
    name: "أحمر - عاجل",
    color: "bg-red-500",
...
// Pre-built templates for common news graphics - Property ME style, minimal and professional
const templates = {
  infographic: {
