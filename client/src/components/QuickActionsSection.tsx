...
interface QuickAction {
  ...
  testId: string;
  permissions: string[];
  // Optional custom predicate so an action can fall back to a role-based check
  // when its primary permission is missing or out of sync.
  isVisible?: (user: ReturnType<typeof useAuth>["user"]) => boolean;
}
