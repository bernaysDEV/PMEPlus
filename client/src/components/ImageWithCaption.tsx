...
export function ImageWithCaption({
  ...
  const normalizedUrl = imageUrl.startsWith('/public-objects/')
  ...
  return (
    <figure className={`my-6 ${className}`} data-testid="figure-image-with-caption">
      <div className="relative bg-muted/30 rounded-md overflow-hidden" style={{ minHeight: loaded ? undefined : '200px', contain: 'layout' }}>
        {error ? (
