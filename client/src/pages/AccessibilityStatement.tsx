...
const translations = {
  ...
  en: {
    ...
    pageSubtitle: "Our Commitment to Making Property ME Accessible to Everyone",
    ...
    complianceContent: "Property ME platform is compliant with <strong>Web Content Accessibility Guidelines (WCAG) 2.1</strong> at Level AA. This means the website meets internationally recognized accessibility standards to ensure it can be used by all people, including those with disabilities.",
    ...
    testingIntro: "Property ME platform is regularly tested using:",
    ...
    contactIntro: "We are constantly working to improve accessibility on the Property ME platform. If you encounter any difficulties using the site or have suggestions for improving the access experience, please contact us:",
    emailLabel: "Email:",
    ...
    // Footer
    footerAppliesTo: "This accessibility statement applies to Property ME platform (sabq.org)",
