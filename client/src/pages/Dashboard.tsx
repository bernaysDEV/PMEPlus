  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex-1 space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-foreground" data-testid="text-greeting">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Users className="h-4 w-4 text-primary" data-testid="icon-users" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
        ...
        <div className="space-y-3">
          <SectionHeader title="إحصائيات إضافية" />
        ...
        <div className="space-y-3">
          <SectionHeader title="خدمات المنصة" />
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
            {/* Audio Newsletters */}
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Headphones className="h-4 w-4 text-primary" data-testid="icon-audio-newsletters" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Brain className="h-4 w-4 text-primary" data-testid="icon-deep-analyses" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Building2 className="h-4 w-4 text-primary" data-testid="icon-publishers" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <HardDrive className="h-4 w-4 text-primary" data-testid="icon-media-library" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
        ...
        {/* Section: AI Features */}
        <div className="space-y-3">
          <SectionHeader title="الذكاء الاصطناعي" />
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
            {/* AI Tasks */}
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Bot className="h-4 w-4 text-primary" data-testid="icon-ai-tasks" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Image className="h-4 w-4 text-primary" data-testid="icon-ai-images" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
              ...
              <div className="p-2 rounded-md bg-primary/10">
                <Blocks className="h-4 w-4 text-primary" data-testid="icon-smart-blocks" />
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
      ...
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0">
          <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
            <BellRing className="h-5 w-5 text-primary animate-pulse" data-testid="icon-bell-ring" />
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h3 className="font-semibold text-foreground" data-testid="text-banner-title">
                  تذكير قريب جداً
                </h3>
                <Badge 
                  variant="outline"
              ...
              <Link href={`/calendar/${reminder.eventId}`} data-testid="link-reminder-event">
                <p className="text-sm text-foreground font-medium mb-2 hover:underline" data-testid="text-banner-event">
                  {reminder.eventTitle}
                </p>
              </Link>
          ...
          {urgentReminders.length > 1 && (
            <p className="text-xs text-muted-foreground mt-2" data-testid="text-more-reminders">
