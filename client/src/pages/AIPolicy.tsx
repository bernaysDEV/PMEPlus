      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            شروط وأحكام استخدام محتوى بروبرتي ME في تطبيقات وأنظمة الذكاء الاصطناعي
          </p>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 leading-relaxed">
              <p>
                تحدد هذه السياسة الشروط والأحكام التي تحكم استخدام محتوى بروبرتي ME ("المحتوى") 
              ...
              <p className="text-muted-foreground">
                بروبرتي ME هي مصدر إخباري موثوق يقدم تغطية شاملة للأخبار العربية. نحن ملتزمون بدعم 
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-green-50 dark:bg-green-950/20 p-4 rounded-lg">
                ...
                <div className="mt-2 p-3 bg-background rounded border text-sm" dir="ltr">
                  <code>"المصدر: بروبرتي ME — [رابط المقال]"</code>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      اصطناعي أساسية بدون اتفاق مكتوب مسبق مع بروبرتي ME.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      يُمنع بيع محتوانا أو استخدامه مباشرة لأغراض تجارية بدون اتفاق شراكة مع بروبرتي ME.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 leading-relaxed">
              <p>
                جميع المحتويات المنشورة على بروبرتي ME محمية بموجب قوانين حقوق النشر والملكية الفكرية. 
              ...
              <p className="text-sm text-muted-foreground">
                هذا الترخيص قابل للإلغاء في حالة انتهاك أي من شروط هذه السياسة. تحتفظ بروبرتي ME بالحق 
          ...
          <Card className="border-muted">
            <CardContent className="pt-6">
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                ضمانات من أي نوع. لا تتحمل بروبرتي ME أي مسؤولية عن أي أضرار ناتجة عن استخدام المحتوى 
                أو واجهات برمجة التطبيقات. يتحمل المستخدم المسؤولية الكاملة عن الامتثال لهذه السياسة 
                وأي قوانين ولوائح معمول بها. باستخدام خدماتنا، فإنك توافق على تعويض بروبرتي ME عن أي 
