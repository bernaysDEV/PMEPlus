...
import { useAuth, hasAnyPermission, canCreateArticles } from "@/hooks/useAuth";
...
export default function ArticlesManagement() {
  ...
  // Allow a role-based fallback so the "New Article" entry point stays visible
  // for editorial roles even if the `articles.create` permission has not been
  // synced yet. Server-side POST routes remain protected by the permission.
  const canCreateArticle = canCreateArticles(user);
