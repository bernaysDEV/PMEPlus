...
const privacyFaqs = [
  {
    id: 'data-usage',
    question: 'كيف تستخدم بروبرتي ME بياناتي الشخصية؟',
  ...
  },
  {
    ...
    answer: 'لا، نحن نلتزم بعدم مشاركة بياناتك الشخصية مع أي جهة خارجية. بياناتك محمية وتُستخدم حصرياً لخدمات بروبرتي ME الإخبارية.',
  },
  {
    id: 'data-protection',
                ...
                <div>
                  ...
                  <ol className="space-y-3 text-muted-foreground" data-testid="list-unsubscribe-steps">
                    <li className="flex items-start gap-3">
                      ...
                      <span>افتح أي رسالة نشرة إخبارية من بروبرتي ME</span>
                    </li>
                    <li className="flex items-start gap-3">
