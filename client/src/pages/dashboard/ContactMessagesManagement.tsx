...
const statusVariants: Record<ContactMessageStatus, "default" | "secondary" | "outline"> = {
  pending: "outline",
  read: "secondary",
  replied: "default",
};
                        ...
                        {messages.map((message) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell>
                                <Badge
                                  variant={statusVariants[message.status as ContactMessageStatus]}
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Badge
                      variant={statusVariants[selectedMessage.status as ContactMessageStatus]}
