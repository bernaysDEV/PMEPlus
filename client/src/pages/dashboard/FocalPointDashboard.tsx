    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card data-testid="card-stat-with-focal">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground" data-testid="text-with-focal">
        ...
        <Card data-testid="card-stat-missing">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground" data-testid="text-missing-focal">
              {statsLoading ? "..." : missingFocalPoints.toLocaleString("ar-SA")}
            </div>
          </CardContent>
        </Card>

        <Card data-testid="card-stat-needs-review">
          <CardHeader className="flex flex-row items-center justify-between gap-1 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">تحتاج مراجعة</CardTitle>
            <AlertTriangle className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-foreground" data-testid="text-needs-review">
