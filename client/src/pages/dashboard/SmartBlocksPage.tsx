      ...
      <div className="space-y-6" dir="rtl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card data-testid="card-stat-active">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground" data-testid="text-stat-active">
                      ...
                      <TableRow key={block.id} data-testid={`row-block-${block.id}`}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className={`text-sm ${block.isActive ? 'text-foreground' : 'text-muted-foreground'}`}>
