...
const typeConfig: Record<string, { variant: "default" | "secondary" | "outline" | "destructive"; label: string; icon: typeof Info }> = {
  info: { variant: "secondary", label: "معلومات", icon: Info },
  success: { variant: "default", label: "نجاح", icon: CheckCircle },
  warning: { variant: "outline", label: "تحذير", icon: AlertTriangle },
  feature: { variant: "outline", label: "ميزة جديدة", icon: Sparkles },
};
                  ...
                  {announcements.map((announcement) => {
                    ...
                    return (
                      <TableRow key={announcement.id} data-testid={`row-announcement-${announcement.id}`}>
                        ...
                        <TableCell>
                          <Badge variant={config.variant} data-testid={`badge-type-${announcement.id}`}>
                            {config.label}
                          </Badge>
                        </TableCell>
