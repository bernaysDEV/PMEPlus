      ...
      <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-6" dir="rtl">
        ...
        <Card className="hover-elevate transition-all">
          <CardContent className="p-6">
            <SectionHeader title="الإعدادات العامة" />
        ...
        <Card className="hover-elevate transition-all">
          <CardContent className="p-6">
            <SectionHeader title="قناة البريد الإلكتروني" />
        ...
        <Card className="hover-elevate transition-all">
          <CardContent className="p-6">
            <SectionHeader title="قناة واتساب" />
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-foreground">التنبيهات مفعّلة</h3>
          ...
          <Card className="hover-elevate transition-all">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-foreground">التنبيهات معطّلة</h3>
                  <p className="text-sm text-muted-foreground mt-1">
