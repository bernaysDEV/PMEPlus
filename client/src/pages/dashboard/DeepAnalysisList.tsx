      ...
      <div className="space-y-6" dir="rtl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card data-testid="card-stat-views">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground" data-testid="text-stat-views">
          ...
          <Card data-testid="card-stat-shares">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground" data-testid="text-stat-shares">
          ...
          <Card data-testid="card-stat-downloads">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground" data-testid="text-stat-downloads">
