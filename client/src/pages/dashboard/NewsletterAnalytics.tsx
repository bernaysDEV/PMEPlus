              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <div className="p-3 rounded-lg bg-muted/50">
                    ...
                    <p className="text-xl font-bold" data-testid="stat-opens">
                      {campaign.openCount.toLocaleString("ar-SA")}
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-muted/50">
                    <p className="text-xs text-muted-foreground">النقرات</p>
                    <p className="text-xl font-bold" data-testid="stat-clicks">
                      ...
                      {campaign.events.slice(0, 10).map((event) => (
                        ...
                        >
                          <div className="flex items-center gap-2 min-w-0">
                            {event.eventType === "opened" && <Eye className="h-4 w-4 text-muted-foreground flex-shrink-0" />}
                            {event.eventType === "clicked" && <MousePointer className="h-4 w-4 text-muted-foreground flex-shrink-0" />}
