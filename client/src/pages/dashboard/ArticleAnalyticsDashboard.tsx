          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              <div className="p-2 rounded-lg bg-muted/50 text-center">
                ...
                <p className="text-lg font-bold">{article.commentsBreakdown.approved}</p>
              </div>
              <div className="p-2 rounded-lg bg-muted/50 text-center">
                <p className="text-xs text-muted-foreground">قيد المراجعة</p>
                <p className="text-lg font-bold">{article.commentsBreakdown.pending}</p>
              </div>
              <div className="p-2 rounded-lg bg-muted/50 text-center">
                <p className="text-xs text-muted-foreground">مرفوضة</p>
                <p className="text-lg font-bold">{article.commentsBreakdown.rejected}</p>
              </div>
              <div className="p-2 rounded-lg bg-muted/50 text-center">
                <p className="text-xs text-muted-foreground">مُبلغ عنها</p>
                <p className="text-lg font-bold">{article.commentsBreakdown.flagged}</p>
              </div>
            </div>
          </div>
        )}
