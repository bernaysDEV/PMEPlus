...
export const swaggerSpec = {
  openapi: '3.0.3',
  info: {
    title: 'Property ME Platform API',
    version: '1.0.0',
    description: 'منصة بروبرتي ME الذكية - واجهة برمجة التطبيقات',
    contact: {
      name: 'Property ME Support',
      email: 'info@sabq.org',
    },
    license: {
      name: 'Proprietary',
...
export function setupSwagger(app: Express): void {
  ...
  app.use('/api-docs', 
    ...
    swaggerUi.setup(swaggerSpec, {
      ...
      customSiteTitle: 'Property ME Platform API Documentation',
