...
استخدم اللغة العربية الفصحى. اجعل التحليل جاهزاً للنشر كقصة إخبارية في بروبرتي ME.`;
...
function buildStoryPrompt(dataset: ParsedDataset, analysis: AnalysisResult, fileName: string): string {
  return `أنت صحفي بيانات محترف في بروبرتي ME السعودية. متخصص في كتابة القصص الإخبارية القائمة على البيانات باللغة العربية الفصحى بأسلوب احترافي جذاب.
...
**1. العنوان (Title):**
- استخدم أسلوب بروبرتي ME الصحفي: جذاب، مشوّق، يحمل دراما بيانية
...
{
  "title": "عنوان صحفي جذاب بأسلوب بروبرتي ME (لا تزيد عن 80 حرفاً)",
...
تذكّر: القصة يجب أن تكون جاهزة للنشر مباشرة في بروبرتي ME دون تعديل. استخدم لغة صحفية احترافية، أرقاماً دقيقة، تفسيرات سياقية، ومقارنات درامية.`;
}
