  ...
  try {
    ...
    for (const entry of tasksToProcess) {
      try {
        ...
        const SABQ_AI_AUTHOR_ID = 'bkIhDx7BM8quPu2W1tB6Z'; // "بروبرتي ME AI" (sabqai@sabq.org)
        ...
        const articleData = {
          ...
          // Author: Always use "بروبرتي ME AI" for iFox articles
          ...
          // CRITICAL: Mark as AI-generated to filter from Property ME main site
          aiGenerated: true,
