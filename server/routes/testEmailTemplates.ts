  ...
  app.post("/api/admin/test-email-templates", requireAuth, requireRole("system_admin"), async (req: any, res) => {
    try {
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <h1>مرحباً بك في بروبرتي ME!</h1>
            </div>
            
            <div class="content">
              <h2>أهلاً بك في عائلة بروبرتي ME!</h2>
              <p>شكراً لانضمامك إلى بروبرتي ME - المصدر الأول للأخبار في المملكة العربية السعودية.</p>
              ...
              <div class="en-section">
                ...
                <p>Thank you for joining Property ME - Saudi Arabia's leading news source. Start exploring the latest news and enjoy personalized recommendations.</p>
              </div>
            </div>
      ...
      const welcomeResult = await sendEmailNotification({
        to: email,
        subject: '🎉 مرحباً بك في بروبرتي ME! - Welcome to Property ME!',
        html: welcomeHtml,
      });
      ...
      const verificationResult = await sendEmailNotification({
        to: email,
        subject: 'تفعيل حسابك في بروبرتي ME - Activate Your Property ME Account',
      ...
      const passwordResetResult = await sendEmailNotification({
        to: email,
        subject: 'إعادة تعيين كلمة المرور - Password Reset | بروبرتي ME',
      ...
      const interestsResult = await sendEmailNotification({
        to: email,
        subject: '✅ تم تسجيل اهتماماتك بنجاح! | بروبرتي ME',
