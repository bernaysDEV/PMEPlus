...
function getHelpMessage(): string {
  return `🤖 *أوامر واتساب بروبرتي ME*
...
router.post("/webhook", async (req: Request, res: Response) => {
  ...
  try {
    ...
    */
    ...
    // 📰 Newspaper account ID for default reporter ("بروبرتي ME")
    ...
    const article = await storage.createArticle({
      ...
      reporterId: NEWSPAPER_ACCOUNT_ID, // 📰 Default to بروبرتي ME for WhatsApp articles
