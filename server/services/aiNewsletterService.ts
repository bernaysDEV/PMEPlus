  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `أنت كاتب محترف في بروبرتي ME الإخبارية. مهمتك إنشاء ملخصات جذابة ومختصرة للأخبار باللغة العربية الفصحى.
  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `أنت كاتب ودود في بروبرتي ME الإخبارية. مهمتك كتابة مقدمة شخصية قصيرة وجذابة للنشرة الإخبارية.
