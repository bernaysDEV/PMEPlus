    ...
    const htmlContent = `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>مرحباً بك في بروبرتي ME!</h2>
            <p>شكراً لتسجيلك في بروبرتي ME. لتفعيل حسابك والاستمتاع بجميع المزايا، يرجى تأكيد بريدك الإلكتروني.</p>
            ...
            <div class="en-section">
              <h2>Welcome to Property ME!</h2>
              <p>Thank you for registering with Property ME. To activate your account and enjoy all features, please confirm your email address.</p>
          ...
          <div class="footer">
            <p>© ${new Date().getFullYear()} بروبرتي ME - Property ME</p>
...
If you didn't sign up, please ignore this email.
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject('تفعيل حسابك في بروبرتي ME - Activate Your Property ME Account')
      .setHtml(htmlContent)
      .setText(textContent);
...
export async function sendPasswordResetEmail(email: string, resetToken: string): Promise<{ success: boolean; error?: string }> {
  try {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك في بروبرتي ME.</p>
            ...
            <div class="en-section">
              ...
              <p>We received a request to reset the password for your Property ME account.</p>
              <p style="color: #999; font-size: 13px;">
                Or copy and paste this link into your browser:<br>
                <span style="color: #dc2626; word-break: break-all;">${resetLink}</span>
              </p>
    ...
    const textContent = `
إعادة تعيين كلمة المرور - بروبرتي ME
...
If you didn't request a password reset, please ignore this email.
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject('إعادة تعيين كلمة المرور - Password Reset | بروبرتي ME')
      .setHtml(htmlContent)
      .setText(textContent);
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>شكراً لاشتراكك في النشرة الإخبارية الذكية من بروبرتي ME. ستصلك أهم الأخبار والتحليلات مباشرة إلى بريدك الإلكتروني.</p>
...
شكراً لاشتراكك في النشرة الإخبارية الذكية من بروبرتي ME.
...
---
© ${new Date().getFullYear()} بروبرتي ME
    `.trim();
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject('✅ تم اشتراكك في النشرة الذكية | بروبرتي ME')
      .setHtml(htmlContent)
      .setText(textContent);
    ...
    const htmlContent = `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>${greeting}،</h2>
            <p>نؤكد لك أنه تم إلغاء اشتراكك من النشرة الإخبارية الذكية لبروبرتي ME بنجاح.</p>
...
نؤكد لك أنه تم إلغاء اشتراكك من النشرة الإخبارية الذكية لبروبرتي ME بنجاح.
...
© ${new Date().getFullYear()} بروبرتي ME
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject('👋 تم إلغاء اشتراكك | بروبرتي ME')
      .setHtml(htmlContent)
      .setText(textContent);
