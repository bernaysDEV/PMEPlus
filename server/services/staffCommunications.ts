...
export class StaffCommunicationsService {
  ...
  private getLogoUrl(): string {
    return `${this.getFrontendUrl()}/branding/property-me-mark.png`;
  }
    ...
    <div class="container">
      <div class="header">
        <div class="logo-container">
          <img src="${logoUrl}" alt="بروبرتي ME" />
        </div>
        <p class="header-text">رسالة من إدارة بروبرتي ME</p>
      </div>
      <div class="content">
        ${content}
      </div>
      <div class="footer">
        <p>هذه الرسالة موجهة لفريق عمل بروبرتي ME</p>
