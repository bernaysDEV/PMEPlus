...
const LOGO_PATH = '/branding/property-me-mark.png';
...
function getDefaultTemplate(type: TemplateType): { subject: string; bodyHtml: string; bodyText: string } {
  ...
  const templates: Record<TemplateType, { subject: string; bodyHtml: string; bodyText: string }> = {
    correspondent_approved: {
      subject: '🎉 تهانينا! تمت الموافقة على طلبك للانضمام إلى فريق بروبرتي ME',
      bodyHtml: `
        <!DOCTYPE html>
        ...
        <body>
          <div class="wrapper">
            <div class="container">
              <div class="header">
                <div class="logo-container"><img src="${getLogoUrl()}" alt="بروبرتي ME" onerror="this.parentElement.style.display='none'" /></div>
                <p class="header-text">بروبرتي ME</p>
              </div>
              ...
              <div class="content">
                ...
                <p>يسعدنا إبلاغك بأنه قد تمت الموافقة على طلبك للانضمام إلى فريق المراسلين في بروبرتي ME.</p>
                
                <div class="info-card">
                  <p class="info-card-label">مرحباً بك في عائلة بروبرتي ME!</p>
                ...
                <div class="signature">
                  <p>مع أطيب التحيات،</p>
                  <p><strong>فريق بروبرتي ME</strong></p>
                </div>
              </div>
              
              <div class="footer">
                <p>© ${new Date().getFullYear()} بروبرتي ME</p>
...
يسعدنا إبلاغك بأنه قد تمت الموافقة على طلبك للانضمام إلى فريق المراسلين في بروبرتي ME.

مرحباً بك في عائلة بروبرتي ME! نحن سعداء بانضمامك إلينا ونتطلع لتعاون مثمر معك.
...
فريق بروبرتي ME
    ...
    correspondent_rejected: {
      subject: 'بخصوص طلبك للانضمام إلى فريق بروبرتي ME',
      bodyHtml: `
        <!DOCTYPE html>
        <html dir="rtl" lang="ar">
        <head>
          ...
          <div class="wrapper">
            <div class="container">
              ...
              <div class="content">
                ...
                <p>نشكرك على اهتمامك بالانضمام إلى فريق المراسلين في بروبرتي ME.</p>
                ...
                <div class="signature">
                  <p>مع أطيب التحيات،</p>
                  <p><strong>فريق التوظيف - بروبرتي ME</strong></p>
                </div>
              </div>
...
شكراً لاهتمامك بالانضمام إلى فريق المراسلين في بروبرتي ME.
...
فريق بروبرتي ME
    ...
    opinion_author_approved: {
      subject: '🎉 تهانينا! تم قبول طلبك ككاتب رأي في بروبرتي ME',
      bodyHtml: `
        <!DOCTYPE html>
        <html dir="rtl" lang="ar">
        <head>
          ...
          <div class="wrapper">
            <div class="container">
              ...
              <div class="content">
                ...
                <p>يسعدنا إبلاغك بأنه تم قبول طلبك للانضمام إلى فريق كتّاب الرأي في بروبرتي ME.</p>
...
يسعدنا إبلاغك بأنه تم قبول طلبك للانضمام إلى فريق كتّاب الرأي في بروبرتي ME.
...
فريق بروبرتي ME
    ...
    opinion_author_rejected: {
      subject: 'بخصوص طلبك للانضمام ككاتب رأي في بروبرتي ME',
      bodyHtml: `
        <!DOCTYPE html>
        <html dir="rtl" lang="ar">
        <head>
          ...
          <div class="wrapper">
            <div class="container">
              ...
              <div class="content">
                ...
                <p>نشكرك على اهتمامك بالانضمام إلى فريق كتّاب الرأي في بروبرتي ME.</p>
...
شكراً لاهتمامك بالانضمام إلى فريق كتّاب الرأي في بروبرتي ME.
          ...
          <div class="wrapper">
            <div class="container">
              ...
              <div class="content">
                ...
                <p>شكراً لمساهمتك القيمة في إثراء محتوى بروبرتي ME.</p>
...
شكراً لمساهمتك القيمة في إثراء محتوى بروبرتي ME.
          ...
          <div class="wrapper">
            <div class="container">
              ...
              <div class="content">
                ...
                <p>شكراً لتقديم مقالتك إلى بروبرتي ME.</p>
                ...
                <div class="signature">
                  <p>مع أطيب التحيات،</p>
                  <p><strong>فريق التحرير - بروبرتي ME</strong></p>
                </div>
              </div>
...
شكراً لتقديم مقالتك إلى بروبرتي ME.
...
فريق بروبرتي ME
    ...
    motivational: {
      subject: '💪 رسالة تحفيزية من فريق بروبرتي ME',
      bodyHtml: `
        <!DOCTYPE html>
        <html dir="rtl" lang="ar">
        <head>
...
export async function sendOpinionAuthorApprovalEmailExistingUser(
  ...
  try {
    ...
    const subject = 'تهانينا! تم قبول طلبك ككاتب رأي في بروبرتي ME';
    const html = `
      <!DOCTYPE html>
      <html dir="rtl" lang="ar">
      <head>
      ...
      <body>
        <div class="wrapper">
          <div class="container">
            ...
            <div class="footer">
              <p>&copy; ${new Date().getFullYear()} بروبرتي ME</p>
              <p>جميع الحقوق محفوظة</p>
            </div>
          </div>
        </div>
